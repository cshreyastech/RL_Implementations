# https://www.youtube.com/watch?v=H9uCYnG3LlE&list=PL-9x0_FO_lgmP3TtVCD4X1U9oSalSuI1o&index=22
...
class DuelingDeepQNetwork(nn.Module):
  def __init__(self, lr, n_actions, name, input_dims, chkpt_dir='tmp/dqn'):

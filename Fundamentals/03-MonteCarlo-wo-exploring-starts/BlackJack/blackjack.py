# https://www.youtube.com/watch?v=e8ofon3sg8E&list=PL-9x0_FO_lglnlYextpvu39E7vWzHhtNO&index=3
# https://www.gymlibrary.dev/environments/toy_text/blackjack/

"""
Monte carlo deals with systems for which we do not have the model(state - transiation probabilities)
 of the environment
"""
import gym
import numpy as np
